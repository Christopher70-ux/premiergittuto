...
$username = htmlspecialchars($_SESSION['username'] ?? 'Invité', ENT_QUOTES, 'UTF-8');
$email = htmlspecialchars($_SESSION['email'] ?? 'Non renseigné', ENT_QUOTES, 'UTF-8');
$registration_date = htmlspecialchars($_SESSION['registration_date'] ?? 'Date inconnue', ENT_QUOTES, 'UTF-8');
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
	...
	<!-- affichage des informations du profil de l'utilisateur connecté -->
